...
def build_system_prompt(
    *,
    ...
    sections.append(
        ...
        "games, or standards. They happen automatically. Just tell the "
        "teacher: 'I created your complete lesson bundle with 7 files "
        "including differentiated versions and a review game.'\n\n"
        "**Before every task:**\n"
