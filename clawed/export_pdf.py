...
def export_lesson_pdf(
    ...
    meta_style = ParagraphStyle(
        ...
        parent=styles["Normal"],
        fontSize=9,
        textColor="#555555",  # type: ignore[arg-type]  # reportlab accepts hex strings at runtime
        spaceAfter=12,
    )
    ...
    footer_style = ParagraphStyle(
        "Footer", parent=styles["Normal"], fontSize=8, textColor="#888888"  # type: ignore[arg-type]  # reportlab accepts hex strings at runtime
    )
