...
- [x] **DONE:** ASC app record created (Jon signed into ASC in the extension's
      ...
      2026-06-07). **Build 1 processed — processingState VALID** (ready to test
      in TestFlight; no export-compliance hold, usesNonExemptEncryption=false).
      ✅ Loop complete — Claw-ED shipped to TestFlight.
